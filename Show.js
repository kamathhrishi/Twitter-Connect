...
// Returns a Tweet Viewing Menu when function when called. Provides users a option of saving the relevant data as JSON file.\\
			 ...
			 console.log("3.Word Frequency");
			 console.log("4.Frequency of given Word");
...
//Allows users to stream data on particular Topics continiously and store data as JSON when required\\
		  ...
		  console.log("\n");
		  console.log("1. Stream by Topics");
		  console.log("2. Stream by Locations");
		  
		  var Ch=prompt("What do you want to stream by");
		...
		{
		          var N=prompt("Enter number of Locations you want to Stream ");
...
function Tokenize(Data)
{
    			...
    			for(var i=0;i<Data.length;i++)
				{
				  ...
				  Token=(tokenizer.tokenize(Data[i]));
				  Tokens[i]=Token;
...
{	
	prompts.on('line',function(choice){
		  ...
		  else if(choice==6)
		  {
			 ...
			 var Topics=[];
			 Num=prompt("Enter the number of topics");
			 
			 for(var i=0;i<Num;i++)
			 {
			 
			   Topics[i]=prompt("Enter a topic");
			 
			 }
			
			 var N=prompt("Enter number of tweets");
			 
		     SimilarTweets(Topics,N);
